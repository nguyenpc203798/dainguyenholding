...
export const Projects: Project[] = [
  {
    ...
    thumbnail: "https://bdstngroup.vn/thumbs/910x640x1/upload/news/unnamed-1746690660.jpg",
    location: "Bình Dương",
    sections: {
      introduction: {
        title: "GIỚI THIỆU",
      ...
      overview: {
        ...
        chudautu: "Công ty cổ phần Đầu tư Thương mại Bất động sản Đại Quang Minh",
        ...
        dientichnha: "Diện tích đất từ 61,1 – 86 m2, căn góc 101,1 – 106,3 m2. Bố trí 1 phòng khách, 1 phòng bếp, 4 phòng ngủ, garage và sân thượng.",
        tienich: "Công viên cây xanh, phố đi bộ, hồ bơi, spa, trường học, bệnh viện quốc tế, sân golf, quảng trường, khu ẩm thực,…",
        csht: "Đường nhựa 12 - 24 m, vỉa hè cây xanh",
        phaply: "Quy hoạch 1/500, sổ hồng đất - trích lục ra sổ nhà",
        quymo: "Tổng 75 sản phẩm nhà phố xây dựng 1 trệt 2 lầu, mặt tiền đường trước nhà rộng 10 – 14 m",
  ...
  },
  {
    ...
    thumbnail: "https://bdstngroup.vn/upload/filemanager/files/khu-dan-cu-duc-phat-3.png",
    ...
    sections: {
      ...
      overview: {
        ...
        vitri: "Liền kề Quốc lộ 13, Thị trấn Lai Uyên, huyện Bàu Bàng, tỉnh Bình Dương",
        ...
        tienich: "Công viên cây xanh 1,2 ha, trung tâm thương mại dịch vụ, đất y tế, trường học các cấp và chuỗi tiện ích ngoại khu phong phú.",
        csht: "Hệ thống đường nhựa 12 - 24 m, vỉa hè cây xanh, hạ tầng đồng bộ.",
        phaply: "Quy hoạch chi tiết 1/500, pháp lý minh bạch.",
        quymo: "Tổng 1.709 sản phẩm đất nền, mật độ xây dựng khoảng 50 - 60%, tầng cao 1 - 3 tầng.",
  ...
  },
  {
    ...
    thumbnail: "https://datxanh.homes/wp-content/uploads/2024/12/phoi-canh-mau-nha-thang-long-house.jpg",
    ...
    sections: {
      ...
      overview: {
        ...
        chudautu: "Công ty TNHH Đầu tư Kinh doanh Bất động sản Thăng Long House",
        donviphattrien: "CÔNG TY TNHH ĐẦU TƯ VÀ DỊCH VỤ ĐẠI NGUYÊN HOLDING",
        tongdientich: "3,03 ha",
        loaihinh: "Đất nền và nhà phố liền kề",
        quymoxd: "Dự kiến hơn 900 cư dân sinh sống",
        dientichnha: "Diện tích sản phẩm từ 61,9 m2 đến 153,3 m2; nhà phố 1 trệt 2 lầu.",
        tienich: "Trường mầm non, khu vui chơi trẻ em, công viên cây xanh, tiện ích cảnh quan, vỉa hè cây xanh, hạ tầng hoàn chỉnh.",
        csht: "Hạ tầng bàn giao hoàn thiện, đường, trường, trạm, điện nước đầy đủ.",
        phaply: "Pháp lý minh bạch, sổ hồng riêng từng lô, hỗ trợ vay ngân hàng VPBank tới 70%.",
        quymo: "Giai đoạn 1: 68 nền đất; giai đoạn 2: 74 căn nhà phố 1 trệt 2 lầu; giai đoạn 3: 44 căn nhà phố 1 trệt 2 lầu.",
  ...
  },
  {
    ...
    thumbnail: "https://bdstngroup.vn/upload/filemanager/files/Hoang-Nam-Uyen-Hung-3.webp",
    ...
    sections: {
      ...
      overview: {
        ...
        quymoxd: "Quy mô 3 giai đoạn với nhiều phân khu nhà phố và tiện ích nội khu.",
        dientichnha: "Diện tích đất nền: 61 - 122 m2; diện tích nhà phố: 63 - 72 m2; thiết kế 1 trệt 1 lầu, 1 trệt 2 lầu.",
        tienich: "Công viên nội khu, khu thể thao, trung tâm thương mại, trường học nội khu cùng chuỗi tiện ích ngoại khu phong phú.",
        csht: "Hạ tầng hoàn thiện, quy hoạch nội khu đồng bộ, đường nội bộ, vỉa hè, cây xanh đầy đủ.",
        phaply: "Sổ hồng riêng từng sản phẩm, sẵn sàng sang tên công chứng ngay, đã được phê duyệt quy hoạch và giấy phép xây dựng.",
        quymo: "14,98 ha với nhiều phân khu nhà phố, shophouse và đất nền đa dạng.",
        thoigian: "Dự án đã hoàn thiện hạ tầng, tiện ích và đang triển khai các giai đoạn tiếp theo.",
      },
      location: {
        title: "VỊ TRÍ DỰ ÁN",
        content: [
  ...
  },
  {
    ...
    thumbnail: "https://lh7-rt.googleusercontent.com/docsz/AD_4nXfYxPi6cSUEIMBxHJaEBBPtNpA28Z8RtQ7P7At0mmY6Y2RiQ7qfiC_9t-_fCJEfhtwBbhNvnabLrsa0Zbu5isOdFWsG61iH_A55PSUk8G6ZZewjXnOT8Bgg5KVcIKUoxvxIAb5BY0lTf6TtBzkRU1C2Qzk?key=r6g9zeHL5P7Iba7HwxOjBg",
    ...
    sections: {
      ...
      overview: {
        ...
        dientichnha: "Diện tích sản phẩm từ 60 - 120 m2; quy cách xây dựng 1 trệt 1 lầu, 1 trệt 2 lầu theo mẫu.",
        tienich: "Công viên nội khu, trường học, trạm y tế, khu trung tâm thương mại, các tiện ích cảnh quan và hạ tầng hoàn chỉnh.",
        csht: "Hạ tầng hoàn thiện, đường nội bộ rộng, hệ thống điện nước, trường trạm đầy đủ.",
        phaply: "Pháp lý hoàn thiện, đã có đầy đủ giấy phép xây dựng, chấp thuận đầu tư và quy hoạch chi tiết 1/500.",
        quymo: "Tổng 95 sản phẩm nhà phố trong khu compound, mật độ xây dựng hợp lý, không gian sống thoáng đãng.",
  ...
  },
  {
    ...
    thumbnail: "https://lh7-rt.googleusercontent.com/docsz/AD_4nXemkB3ejEBqVjcFcQVVgd4uWDRYiy5OdZUf8D71jaAJUCZLGpdgRtZpOhC61f5Cuh8nz-7eP2XZg_LvXYilvbFVhSpuO_FWmqFCJd5UVqwYh31uhRJu_WtY97VHKwyQKMHOhl6LyXUyKJFejUJ1EzEk_RJg?key=r6g9zeHL5P7Iba7HwxOjBg",
    ...
    sections: {
      ...
      overview: {
        ...
        vitri: "Đường Thuận An Hòa, phường Thuận Giao, TP. Thuận An, Bình Dương",
        chudautu: "Công ty TNHH Đầu tư và Phát triển Lê Phong",
        donviphattrien: "CÔNG TY TNHH ĐẦU TƯ VÀ DỊCH VỤ ĐẠI NGUYÊN HOLDING",
        tongdientich: "23.811 m2",
        loaihinh: "Đất nền và nhà phố thương mại",
        quymoxd: "Tổng khoảng 200 sản phẩm, trong đó phân khu Thuận Area gồm 71 lô đất nền và 14 căn nhà phố.",
        dientichnha: "Diện tích sản phẩm từ 67 - 136 m2; nhà phố tối ưu công năng, phù hợp an cư và kinh doanh.",
        tienich: "Thừa hưởng đầy đủ tiện ích trung tâm TP. Thuận An: trung tâm thương mại, siêu thị, trường học, bệnh viện, công viên…",
        csht: "Hạ tầng hoàn thiện với đường rộng, hệ thống điện âm, hạ tầng an ninh hiện đại.",
        phaply: "Pháp lý hoàn chỉnh, đã có sổ hồng riêng cho các sản phẩm tại phân khu Thuận Area.",
        quymo: "Phân khu Thuận Area: 71 lô đất nền và 14 căn nhà phố, diện tích 67,5 - 136 m2.",
        thoigian: "Đang triển khai kinh doanh, tiềm năng tăng giá cao theo tiến trình phát triển của Thuận An.",
        images: [
